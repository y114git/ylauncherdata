...
* **Новая функция: Ярлыки! (Ура!)** Теперь вы можете создать ярлык для запуска с вашими настройками. Просто настройте все, как вам нравится, нажмите "Ярлык", и лаунчер создаст специальный файл запуска. При клике на него игра запустится с выбранными переводами и настройками, а сам лаунчер даже не появится на экране.
